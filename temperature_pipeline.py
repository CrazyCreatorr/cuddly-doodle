...
<body>
    ...
    def run_complete_pipeline(self):
        ...
        print(f"📦 Created {len(mbtiles_files)} MBTiles files")
        print("\n📋 Next steps:")
        print("1. Start tileserver: tileserver-gl --config temperature-tileserver-config.json --port 8080")
        print("2. Open temperature-viewer.html in your browser")
        print("3. Explore temperature data interactively!")
